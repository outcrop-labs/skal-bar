// Weather helpers ported from the omarchy shell weather panel
// (plugins/panels/weather/Model.js) so the quick menu renders the same
// conditions and nerd-font glyphs without importing host-internal paths.
